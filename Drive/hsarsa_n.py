...
dr = Driving(ishuman_n=True) # Precise in the initialization that we are builduing
                            # the human policy for Driving and Avoiding
trajectory = {}
episode_rewards = []
collisions = []
cat_hits = []
...
with open('./policies/'+str(args.id)+'_hpolicy_drive_n.pkl', 'wb') as f:
